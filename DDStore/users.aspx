<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="DDStore.users" %>
...
<style type="text/css">
    ...
    <h1>Users</h1>
    <a href="userAdd.aspx"><button class="btn btn-warning">Add User</button></a>
</div>

    <form id="form1" runat="server">
        
 <div class="tableDiv">
            <asp:GridView ID="GridView1" runat="server" CssClass="tableSC" OnRowCommand="GridView1_RowCommand">
