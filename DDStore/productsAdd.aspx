<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productsAdd.aspx.cs" Inherits="DDStore.productsAdd" %>
...
<asp:Label ID="Error" runat="server"  ForeColor="#CC3300"></asp:Label>
            ...
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btnSubmitMenu btn btn-warning" OnClick="btnSubmit_Click" />
        </form>
  </div> 
